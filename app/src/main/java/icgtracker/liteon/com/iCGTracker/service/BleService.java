...
import icgtracker.liteon.com.iCGTracker.util.DateUtils;
import icgtracker.liteon.com.iCGTracker.util.Utils;

import static icgtracker.liteon.com.iCGTracker.util.Def.*;
...
public class BleService extends Service {
    ...
    private void getChartacteristicValue(
        ...
        mIntent.putExtra("time", DateUtils.getCurrentDatatime());
    ...
    public boolean init() {
        ...
        bleSeviceFilter.addAction(FIND_DEVICE_ALARM_ON);
        bleSeviceFilter.addAction(CANCEL_DEVICE_ALARM);
